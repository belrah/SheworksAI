  ...
  const onSubmit = (data: LoginFormData) => {
    ...
    if (data.email === userData.email) {
      ...
      if (data.rememberMe) {
        ...
        localStorage.setItem('rememberedUserEmail', data.email);
      } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#fff7f5] to-white flex items-center justify-center py-8 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl lg:text-4xl text-[#232557] mb-2">Welcome Back</h1>
          <p className="text-[#374758] text-lg">Log in to find your next opportunity</p>
        </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <label htmlFor="rememberMe" className="text-sm text-[#374758] leading-none cursor-pointer">
                    Remember me
                  </label>
                </div>
              ...
              <Button type="submit" className="w-full bg-[#f75524] hover:bg-[#e54414] text-white h-12">
                Sign In
              </Button>
            </form>
        ...
        <div className="text-center mt-6">
          <p className="text-[#374758]">
            ...
            <button onClick={() => navigate('/user/signup')} className="text-[#f75524] hover:underline">
              Sign up
            </button>
          </p>
        </div>
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-[#374758]">
            Looking to hire?{' '}
            <button onClick={() => navigate('/employer/login')} className="text-[#f75524] hover:underline">
              Employer Login
            </button>
          </p>
        </div>
        ...
        <div className="text-center mt-4">
          <button onClick={() => navigate('/')} className="text-sm text-[#374758] hover:text-[#f75524] transition-colors">
            ← Back to home
          </button>
        </div>
      </div>
